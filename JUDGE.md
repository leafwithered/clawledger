...
4. Open the [final successful CI validation](https://github.com/leafwithered/clawledger/actions/runs/30979810068).
5. Check the [official Skill installation evidence](docs/SKILL_INSTALLATION_EVIDENCE.md).
