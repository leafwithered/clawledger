...
Replace the angle-bracket placeholders only after the final devnet anchor and
recording are public. Never include a bot token, wallet recovery phrase, raw
ZeroClaw trace, model credential, or operator identifier.
